...
****************************************************************
TEACH1D START 0                  start main code csect at base 0
        SAVE  (14,12)            Save input registers
        LR    R12,R15            base register := entry address
        USING TEACH1D,R12        declare base register
...
ATEND   CLOSE TEACHERS
        ...
        WTO   'TEACH1D ... Teacher list on HERC01.TEST.SEQ(TEACHRPT)'
...
TEACHRPT DCB   DSORG=PS,MACRF=PM,DDNAME=TEACHRPT,                      X
        ...
        YREGS ,
        END   TEACH1D            define main entry point
/*
//LKED     EXEC PGM=IEWL,
//             COND=(5,LT,ASMF1),
