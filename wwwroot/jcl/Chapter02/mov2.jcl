...
//             TIME=1440,
//             MSGLEVEL=(1,1)
//MOV2  EXEC ASMFCG,PARM.ASM=(OBJ,NODECK),MAC1='SYS2.MACLIB',
...
MOV2   START 0                  start main code csect at base 0
        SAVE  (14,12)            Save input registers
        LR    R12,R15            base register := entry address
        USING MOV2,R12          declare base register
...
SYSPRINT DCB   DSORG=PS,MACRF=PM,DDNAME=SYSPRINT,                      X
        ...
        YREGS ,
        END   MOV2              define main entry point
/*
