...
//             TIME=1440,
//             MSGLEVEL=(1,1)
//MOV1  EXEC ASMFCG,PARM.ASM=(OBJ,NODECK),MAC1='SYS2.MACLIB',
...
MOV1   START 0                  start main code csect at base 0
        SAVE  (14,12)            Save input registers
        LR    R12,R15            base register := entry address
        USING MOV1,R12          declare base register
...
SYSPRINT DCB   DSORG=PS,MACRF=PM,DDNAME=SYSPRINT,                      X
        ...
        YREGS ,
        END   MOV1              define main entry point
/*
